...
(function ($) {
	...
	$(window).on("load", function () {
		...
		// Вызываем событие click на элементе фильтра, который должен быть активным по умолчанию
		$("#project-flters li.filter-active").click();
	});
	...
	if ($(".map-canvas").length) {
		...
		var initMap = function () {
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(46.94809, 7.44744),
				map: map,
				icon: myIcon,
			});
		};
